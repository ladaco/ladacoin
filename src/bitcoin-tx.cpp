...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Ladacoin Core ladacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ladacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ladacoin transaction") + "\n" +
              "  ladacoin-tx [options] -create [commands]   " + _("Create hex-encoded ladacoin transaction") + "\n" +
              "\n";
