...
{
    if(Height > pindexBest->nHeight) { return "702528b55f744f690d896095c4ca8642ccf5f6b420a37b5c6db303013b982d24"; }
    if(Height < 0) { return "702528b55f744f690d896095c4ca8642ccf5f6b420a37b5c6db303013b982d24"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " LDC");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " LDC");
    }
}
