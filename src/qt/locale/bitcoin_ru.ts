...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Ladacoin для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Ladacoin для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Ladacoin</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Ladacoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашим адресом Ladacoin, чтобы доказать, что вы им владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Ladacoin addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом Ladacoin</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>&amp;О Ladacoin Core</translation>
    </message>
    <message>
        <source>Modify configuration options for Ladacoin Core</source>
        <translation>Изменить опции конфигурации Ladacoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать помощь по Ladacoin Core и получить список доступных параметров командной строки.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным Ladacoin-адресом.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Ladacoin Core.</translation>
    </message>
    <message>
        <source>As this is the first time the program is launched, you can choose where Ladacoin Core will store its data.</source>
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где Ladacoin Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>Ladacoin Core скачает и сохранит копию цепи блоков. Как минимум, %1ГБ данных будет храниться в этом каталоге, и со временем он будет расти. Бумажник будет также сохранён в этом каталоге.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        <source>The user interface language can be set here. This setting will take effect after restarting Ladacoin Core.</source>
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска Ladacoin Core.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Automatically start Ladacoin Core after logging in to the system.</source>
        <translation>Автоматически запускать Ladacoin Core после входа в систему</translation>
    </message>
    <message>
        <source>&amp;Start Ladacoin Core on system login</source>
        <translation>&amp;Запускать Ladacoin Core при входе в систему</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Ladacoin-клиента на роутере. Работает только если Ваш роутер поддерживает UPnP, и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Ladacoin через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети Ladacoin через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш бумажник автоматически синхронизируется с сетью Ladacoin после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось обработать URI! Это может быть связано с неверным адресом Ladacoin или неправильными параметрами URI.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Ladacoin (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        <source>Open the Ladacoin Core debug log file from the current data directory. This can take a few seconds for large log files.</source>
        <translation>Открыть отладочный лог-файл Ladacoin Core из текущего каталога данных. Это может занять несколько секунд для больших лог-файлов.</translation>
    </message>
    <message>
    ...
    <message>
        <source>Welcome to the Ladacoin Core RPC console.</source>
        <translation>Добро пожаловать в RPC-консоль Ladacoin Core.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Ladacoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Ladacoin </translation>
    </message>
    <message>
        <source>(no label)</source>
        <translation>[нет метки]</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Ladacoin, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
...
<context>
    ...
    <message>
        ...
        <translation>Ladacoin Core выключается...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Ladacoin, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выберите ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение адресом Ladacoin</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;Сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Ladacoin, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Ladacoin address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Ladacoin</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;Сообщение</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Разработчики Ladacoin Core</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удалось забиндиться на %s на этом компьютере. Возможно, Ladacoin Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, Ladacoin Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссии (в LDC/Кб) меньшие этого значения считаются нулевыми для трансляции (по умолчанию: %s)</translation>
    </message>
    <message>
...
Например: alertnotify=echo %%s | mail -s "Ladacoin Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: убедитесь, что дата и время на Вашем компьютере выставлены верно. Если Ваши часы идут неправильно, Ladacoin Core будет работать некорректно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: бумажник требует более новую версию Ladacoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия (в LDC/Кб) для добавления к вашим транзакциям (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Information</source>
        <translation>Информация</translation>
    ...
    <message>
        ...
        <translation>Не удалось проверить чистоту. Ladacoin Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Параметры RPC SSL: (см. Ladacoin вики для инструкций по настройке SSL)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать бумажник, перезапустите Ladacoin Core для завершения операции.</translation>
    </message>
    <message>
        <source>Warning</source>
        <translation>Внимание</translation>
